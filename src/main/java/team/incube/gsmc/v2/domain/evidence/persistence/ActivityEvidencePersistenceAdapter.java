...
import team.incube.gsmc.v2.domain.evidence.persistence.repository.ActivityEvidenceJpaRepository;
...
import static team.incube.gsmc.v2.domain.evidence.persistence.entity.QActivityEvidenceJpaEntity.activityEvidenceJpaEntity;
 ...
 * <p>{@link ActivityEvidencePersistencePort}를 구현하며,
 * 활동 증빙자료에 대한 저장, 조회, 검색, 삭제 기능을 JPA 및 QueryDSL 기반으로 제공합니다.
 * <p>도메인 객체 ↔ JPA 엔티티 간 매핑은 {@link ActivityEvidenceMapper}를 통해 수행됩니다.
 * 주요 기능:
 * <ul>
