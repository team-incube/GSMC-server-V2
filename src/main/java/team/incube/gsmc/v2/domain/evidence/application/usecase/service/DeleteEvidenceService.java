...
import team.incube.gsmc.v2.domain.evidence.application.port.*;
import team.incube.gsmc.v2.domain.evidence.application.usecase.DeleteEvidenceUseCase;
 ...
 * <p>삭제 이후 {@link ScoreUpdatedEvent}를 발행하여 클라이언트에 점수 변경을 알립니다.
