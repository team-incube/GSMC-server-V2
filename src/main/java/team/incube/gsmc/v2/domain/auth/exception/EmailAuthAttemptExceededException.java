...
import team.incube.gsmc.v2.domain.auth.application.usecase.service.SendAuthenticationEmailService;
 ...
 * <p>{@link ErrorCode#EMAIL_AUTH_ATTEMPT_EXCEEDED}에 매핑되어
 * 클라이언트에 적절한 오류 메시지와 상태 코드를 전달합니다.
 * @see SendAuthenticationEmailService
 * @author jihoonwjj
 */
