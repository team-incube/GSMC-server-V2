 ...
 * <p>{@link team.incude.gsmc.v2.global.error.ErrorCode#AUTHENTICATION_NOT_FOUND}에 매핑되어
 * 클라이언트에 적절한 오류 메시지를 전달합니다.
 * @see team.incude.gsmc.v2.domain.auth.persistence.AuthenticationPersistenceAdapter
 * @see team.incude.gsmc.v2.domain.auth.application.port.AuthenticationPersistencePort
 * @author jihoonwjj
 */
