...
public class UpdateOtherEvidenceByCurrentUserService implements UpdateOtherEvidenceByCurrentUserUseCase {
    ...
    public void execute(Long evidenceId, MultipartFile file) {
        ...
        validateNotExistsOther(evidenceId);
    ...
    private void validateNotExistsOther(Long evidenceId) {
        if (otherEvidencePersistencePort.existsOtherEvidenceByEvidenceId(evidenceId)) {
