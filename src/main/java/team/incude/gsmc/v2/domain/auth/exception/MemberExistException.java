 ...
 * <p>{@link team.incude.gsmc.v2.global.error.ErrorCode#MEMBER_ALREADY_EXISTS}에 매핑되어
 * 클라이언트에 적절한 오류 메시지를 반환합니다.
 * @see team.incude.gsmc.v2.domain.auth.application.usecase.service.SignUpService
 * @see team.incude.gsmc.v2.domain.member.application.port.MemberPersistencePort
 * @author jihoonwjj
 */
